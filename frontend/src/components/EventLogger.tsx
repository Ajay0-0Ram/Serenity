...
const EventLogger: React.FC<Props> = ({ emotion }) => {
    ...
    const logEvent = async () => {
        ...
        try {
            ...
            const data: { event_id: number; predictive_stress_level: number; emotion_based_stress_level: number } = await response.json();
